...
#line 71 "src\\main.c"
    ...
    {
        tmp = (* ( volatile uint16*)((0x50000012)) );
        tmp&=~0x0003;
        (* ( volatile uint16*)((0x50000012))=(tmp) );
        sw_reset();
    }
    tmp = (* ( volatile uint16*)((0x50000012)) );
...
#line 99 "src\\main.c"
    ...
    while (!((* ( volatile uint16*)((0x50000014)) ) & (0x0008)));  
...
#line 123 "src\\main.c"
        ...
        if (!ret) {
            (* ( volatile uint16*)((0x50003100))=(0xC8) );          
            (* ( volatile uint16*)((0x50003302))=((0x0008)) );  
