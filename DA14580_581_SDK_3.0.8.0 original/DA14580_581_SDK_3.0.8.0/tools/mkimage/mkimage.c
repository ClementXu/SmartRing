...
static void usage(const char* my_name)
{
	fprintf(stderr,
		...
		"\n"
		"  The 'version_file' is normmaly stored at\n"
		"  dk_apps/src/dialog/include/ble_580_sw_version.h and this\n"
		...
		"\n"
		"Usage case #2:\n"
		"  %s multi spi|eeprom [bloader] in_img1 off1 in_img2 off2 off3 [cfg off4] out_file\n"
		"\n"
		...
		"aristotelis.iordanidis@diasemi.com\n"
		"\n",
		my_name, my_name);
}
