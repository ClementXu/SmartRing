...
void init_uart_pads(void)
{
	...
	uart_sel_pins.uart_port = GPIO_PORT_0;
...
{
	GPIO_ConfigurePin( (GPIO_PORT) uart_sel_pins.uart_port, (GPIO_PIN) uart_sel_pins.uart_tx_pin, OUTPUT, PID_UART1_TX, false);
  GPIO_ConfigurePin( (GPIO_PORT) uart_sel_pins.uart_port, (GPIO_PIN) uart_sel_pins.uart_rx_pin, INPUT, PID_UART1_RX, false);
}

void update_uart_pads(GPIO_PORT port, GPIO_PIN tx_pin, GPIO_PIN rx_pin)
{
	uart_sel_pins.uart_port = port;
...
void init_spi_pads(void)
{
	...
	spi_sel_pins.spi_cs_port = SPI_GPIO_PORT;
	spi_sel_pins.spi_cs_pin = GPIO_PIN_3;
	spi_sel_pins.spi_clk_port = SPI_GPIO_PORT;
	spi_sel_pins.spi_clk_pin = GPIO_PIN_0;
	spi_sel_pins.spi_do_port = SPI_GPIO_PORT;
	spi_sel_pins.spi_do_pin = GPIO_PIN_6;
	spi_sel_pins.spi_di_port = SPI_GPIO_PORT;
	spi_sel_pins.spi_di_pin = GPIO_PIN_5;
}
...
void init_i2c_pads(void)
{
	...
	i2c_sel_pins.i2c_scl_port = I2C_GPIO_PORT;
	i2c_sel_pins.i2c_scl_pin = GPIO_PIN_2;
	i2c_sel_pins.i2c_sda_port = I2C_GPIO_PORT;
	i2c_sel_pins.i2c_sda_pin = GPIO_PIN_3;
}
