...
#if BLE_APP_THROUGHPUT_CENTRAL || BLE_APP_THROUGHPUT_PERIPHERAL

#if BLE_INTEGRATED_HOST_GTL    
    APP_EXT_TEST_REQ, // application api test request
    APP_EXT_TEST_RSP, // application api test response	
    APP_READY_IND, 
	APP_EXT_SCAN_CMD,
    APP_EXT_ADV_REPORT_IND,
    APP_EXT_SCAN_CMP_IND,
    APP_EXT_CONNECT_CMD,
    APP_EXT_CONNECT_CMP_IND,
    APP_EXT_DISCONNECT_CMD,
    APP_EXT_DISCONNECT_CMP_IND,
    APP_EXT_TRANSMIT_CMD,
    APP_EXT_STATS_REPORT,
#endif    
    //Last message of BLE_APP_CENTRAL
    APP_CONN_TIMER,
#endif 
