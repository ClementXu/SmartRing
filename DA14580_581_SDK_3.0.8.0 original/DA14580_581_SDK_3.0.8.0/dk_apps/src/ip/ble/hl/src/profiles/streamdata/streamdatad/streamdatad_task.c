...
//            (uint8_t*)&(param->value[0]));
	...
	//			atts_write_rsp_send(streamdatad_env.conhdl, param->handle, PRF_ERR_OK);
					//add by Clement at 2015.12.18
//				if(value_buf[0] == 's')
//					timer0_start();
//				if(value_buf[0] == 'e')
//					timer0_stop();
				cmdin = app_parase_cmd((uint8_t *)&(param->value),param->length);
				app_handle_cmd(cmdin);
//				if(value_buf[0] == 'b')
//				{
//					int data = adc_get_sample();
//					value_buf[0]=data/1000+0x30;
//					value_buf[1]=data%1000/100+0x30;
//					value_buf[2]=data%100/10+0x30;
//					value_buf[3]=data%10+0x30;
