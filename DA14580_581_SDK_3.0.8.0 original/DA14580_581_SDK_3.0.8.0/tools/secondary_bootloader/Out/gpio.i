#line 1 "..\\..\\dk_apps\\src\\plf\\refip\\src\\driver\\gpio\\gpio.c"
...
#line 19 "..\\..\\dk_apps\\src\\plf\\refip\\src\\driver\\gpio\\gpio.c"
...
#line 20 "..\\..\\dk_apps\\src\\plf\\refip\\src\\driver\\gpio\\gpio.c"
...
#line 21 "..\\..\\dk_apps\\src\\plf\\refip\\src\\driver\\gpio\\gpio.c"

#line 39 "..\\..\\dk_apps\\src\\plf\\refip\\src\\driver\\gpio\\gpio.c"
...
GPIO_handler_function_t GPIOHandlerFunction[(GPIO4_IRQn - GPIO0_IRQn + 1)];
...
void GPIO_init( void )
{
#line 92 "..\\..\\dk_apps\\src\\plf\\refip\\src\\driver\\gpio\\gpio.c"
}
...
{
#line 115 "..\\..\\dk_apps\\src\\plf\\refip\\src\\driver\\gpio\\gpio.c"
    if (port == GPIO_PORT_3)
        port = GPIO_PORT_3_REMAP; 
    
    const int data_reg = (0x50003000) + (port << 5);
    const int mode_reg = data_reg + 0x6 + (pin << 1);
    
    (* ( volatile uint16*)(mode_reg)=(mode | function) );
}
...
void GPIO_ConfigurePin( GPIO_PORT port, GPIO_PIN pin, GPIO_PUPD mode, GPIO_FUNCTION function,
						 const _Bool high )
{
#line 147 "..\\..\\dk_apps\\src\\plf\\refip\\src\\driver\\gpio\\gpio.c"
...
{
#line 175 "..\\..\\dk_apps\\src\\plf\\refip\\src\\driver\\gpio\\gpio.c"
    ...
    const int reg = (0x50003070) + 2* reg_offset;
    ...
    regval = (* ( volatile uint16*)(reg) );
    regval &= ~(1 << bit_offset);        
    regval |= power_rail << bit_offset;  
    (* ( volatile uint16*)(reg)=(regval) );
}
...
{
#line 212 "..\\..\\dk_apps\\src\\plf\\refip\\src\\driver\\gpio\\gpio.c"
    if (port == GPIO_PORT_3)
        port = GPIO_PORT_3_REMAP; 
	...
	(* ( volatile uint16*)(set_data_reg)=(1 << pin) );
}
...
{
#line 240 "..\\..\\dk_apps\\src\\plf\\refip\\src\\driver\\gpio\\gpio.c"
    if (port == GPIO_PORT_3)
        port = GPIO_PORT_3_REMAP; 
	...
	(* ( volatile uint16*)(reset_data_reg)=(1 << pin) );
}
...
_Bool GPIO_GetPinStatus( GPIO_PORT port, GPIO_PIN pin )
{
#line 268 "..\\..\\dk_apps\\src\\plf\\refip\\src\\driver\\gpio\\gpio.c"
    if (port == GPIO_PORT_3)
        port = GPIO_PORT_3_REMAP; 
    
    const int data_reg = (0x50003000) + (port << 5);
    
    return ( ((* ( volatile uint16*)(data_reg) ) & (1 << pin)) != 0 );
}
