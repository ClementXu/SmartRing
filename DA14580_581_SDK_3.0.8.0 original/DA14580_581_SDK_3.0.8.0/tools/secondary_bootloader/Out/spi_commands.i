...
#line 21 "src\\spi_commands.c"
#line 1 ".\\includes\\spi_commands.h"
...
#line 21 ".\\includes\\spi_commands.h"
...
#line 22 "src\\spi_commands.c"
#line 1 "..\\..\\dk_apps\\src\\plf\\refip\\src\\driver\\spi_flash\\spi_flash.h"
...
#line 24 "..\\..\\dk_apps\\src\\plf\\refip\\src\\driver\\spi_flash\\spi_flash.h"
#line 25 "..\\..\\dk_apps\\src\\plf\\refip\\src\\driver\\spi_flash\\spi_flash.h"
...
#line 48 "..\\..\\dk_apps\\src\\plf\\refip\\src\\driver\\spi_flash\\spi_flash.h"


#line 62 "..\\..\\dk_apps\\src\\plf\\refip\\src\\driver\\spi_flash\\spi_flash.h"





#line 75 "..\\..\\dk_apps\\src\\plf\\refip\\src\\driver\\spi_flash\\spi_flash.h"

typedef struct 
{
	uint32_t jedec_id;							
	uint32_t jedec_id_matching_bitmask;			
	uint32_t flash_size;						
	uint32_t page_size;							
	uint8_t memory_protection_bitmask;			
	uint8_t memory_protection_unprotected;  	
...
#line 103 "..\\..\\dk_apps\\src\\plf\\refip\\src\\driver\\spi_flash\\spi_flash.h"

#line 113 "..\\..\\dk_apps\\src\\plf\\refip\\src\\driver\\spi_flash\\spi_flash.h"
...
#line 136 "..\\..\\dk_apps\\src\\plf\\refip\\src\\driver\\spi_flash\\spi_flash.h"
...
#line 23 "src\\spi_commands.c"
#line 24 "src\\spi_commands.c"
#line 25 "src\\spi_commands.c"
...
{ 
    uint16 tmp; 
    (* ( volatile uint16*)((0x50001202))=((uint16_t)x) );    
    do
    {
    ...
    tmp = (* ( volatile uint16*)((0x50001202)) );
...
inline void getByte_SPI(uint8* x  )
{
    ...
    (* ( volatile uint16*)((0x50001202))=((uint16) DUMMY) );
    while (( ((* ( volatile uint16*)((0x50001200)) )&( (uint16)((0x2000)==0) )) >> (((0x2000)==0)&0x0001?0: ((0x2000)==0)&0x0002?1: ((0x2000)==0)&0x0004?2: ((0x2000)==0)&0x0008?3: ((0x2000)==0)&0x0010?4: ((0x2000)==0)&0x0020?5: ((0x2000)==0)&0x0040?6: ((0x2000)==0)&0x0080?7: ((0x2000)==0)&0x0100?8: ((0x2000)==0)&0x0200?9: ((0x2000)==0)&0x0400?10:((0x2000)==0)&0x0800?11: ((0x2000)==0)&0x1000?12:((0x2000)==0)&0x2000?13:((0x2000)==0)&0x4000?14: 15) ));
    (* ( volatile uint16*)((0x50001206))=(0x01) );
    *(uint8*)x=(uint8)(* ( volatile uint16*)((0x50001202)) );   
} 
...
void SpiFlashRead(unsigned long destination_buffer,unsigned long source_addr,unsigned long len)
{
    ...
    (* ( volatile uint16*)((0x50001202))=((uint16) 0) );
    ...
    for (i=0;i<len;i++)
    {
        ...
        __asm volatile ("nop");
        __asm volatile ("nop");
        *(uint8*)(uint32)(destination_buffer+i)=(uint8)(* ( volatile uint16*)((0x50001202)) );
    }
    spi_cs_high();
} 
